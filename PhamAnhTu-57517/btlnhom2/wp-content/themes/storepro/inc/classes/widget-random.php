 ...
 * @since      1.0.0
 */
class StorePro_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-storepro-random posts-thumbnail-widget',
			'description' => __( 'Display random posts with thumbnails.', 'storepro' )
		);

		// Create the widget.
		parent::__construct(
			'storepro-random',                                   // $this->id_base
			__( '&raquo; Random Posts Thumbnails', 'storepro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'storepro' ),
			'limit'     => 5,
			'show_date' => false
		);
