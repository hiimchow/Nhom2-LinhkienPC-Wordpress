 ...
 * @since      1.0.0
 */
class StorePro_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			...
			'description' => __( 'Easily to display any type of ad.', 'storepro' )
		);

		// Create the widget.
		parent::__construct(
			'storepro-ads',                            // $this->id_base
			__( '&raquo; Advertisement', 'storepro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'   => esc_html__( 'Advertisement', 'storepro' ),
			'ad_code' => '',
		);
