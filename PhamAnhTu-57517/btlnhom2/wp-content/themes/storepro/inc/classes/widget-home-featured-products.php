 ...
 * @since      1.0.0
 */
class StorePro_Featured_Prod_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-storepro-featured-prod product product-slider',
			'description' => __( 'Display a slider of your featured products on home page.', 'storepro' )
		);

		// Create the widget.
		parent::__construct(
			'storepro-featured-prod',                             // $this->id_base
			__( '&raquo; Home - Featured Products', 'storepro' ), // $this->name
	...
	function widget( $args, $instance ) {
		...
		if ( $products->have_posts() ) :
			...
			<div id="product-slider" class="owl-carousel collection">
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title' => esc_html__( 'Featured Products', 'storepro' ),
			'limit' => 5,
		);
