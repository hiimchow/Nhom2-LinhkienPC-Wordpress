...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'storepro' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'storepro' ),
		'repeat-y'  => __( 'Repeat Vertically', 'storepro' ),
		'repeat'    => __( 'Repeat All', 'storepro' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'storepro' ),
		'top center'    => __( 'Top Center', 'storepro' ),
		'top right'     => __( 'Top Right', 'storepro' ),
		'center left'   => __( 'Middle Left', 'storepro' ),
		'center center' => __( 'Middle Center', 'storepro' ),
		'center right'  => __( 'Middle Right', 'storepro' ),
		'bottom left'   => __( 'Bottom Left', 'storepro' ),
		'bottom center' => __( 'Bottom Center', 'storepro' ),
		'bottom right'  => __( 'Bottom Right', 'storepro')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'storepro' ),
		'fixed'  => __( 'Fixed in Place', 'storepro')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'storepro' ),
		'italic'      => __( 'Italic', 'storepro' ),
		'bold'        => __( 'Bold', 'storepro' ),
		'bold italic' => __( 'Bold Italic', 'storepro' )
		);
