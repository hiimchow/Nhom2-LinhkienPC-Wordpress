 ...
 * @since      1.0.0
 */
class StorePro_Video_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-storepro-video video-widget',
			'description' => __( 'Easily to display any type of video.', 'storepro' )
		);

		// Create the widget.
		parent::__construct(
			'storepro-video',                  // $this->id_base
			__( '&raquo; Video', 'storepro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Video', 'storepro' ),
			'video_url'  => '',
			'video_code' => ''
		);
